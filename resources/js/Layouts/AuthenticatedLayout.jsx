            ...
            <nav className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/">
                                    <ApplicationLogo className="block h-9 w-12 fill-current text-gray-800 dark:text-gray-200" />
                                </Link>
                            </div>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('my-tasks')} active={route().current('tasks.index')}>
                                    My Tasks
                                </NavLink>
                            </div>
                        </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('my-tasks')} active={route().current('tasks.index')}>
                            My Tasks
                        </ResponsiveNavLink>
                    </div>
